    ...
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            ...
            <div class="container">
                ...
                <hr>
                <div style="margin-left: 460px"><font color="#696969"><h5>Update Chất liệu</h5></font></div>
                <%--@elvariable id="chatLieus" type=""--%>
                <form:form method="post" action="/chat-lieu/update/${chatLieu.id}" modelAttribute="chatLieus">
                    Tên size :<form:input path="ten" class="form-control" type="text" value ="${chatLieu.ten}"/><br>
