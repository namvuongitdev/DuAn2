    ...
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            ...
            <div class="container">
                    ...
                    <form>
                        ...
                        <div class="input-group" style="margin-left: 20px">
                            <div class="form-outline">
                                <input type="search" name="searchMS" value="${param.searchMS}"
                ...
                <form action="/chi-tiet-san-pham/add-mau-sac/${idsp}" method="post">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                        <c:forEach items="${listMau.getContent()}" var="mau" varStatus="i">
                            <tr onclick="window.location.href='/chi-tiet-san-pham/idmau/${idsp}?idmau=${mau.id}';">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-center">
                                <li class="page-item ${pageNo<=1?"disabled":""}"><a class="page-link"
                                                                                    href="/chi-tiet-san-pham/view-mau-sac/${idsp}?searchMS=${param.searchMS}&page=${pageNo-1}">Previous</a>
                                </li>
                                <c:forEach begin="1" end="${listMau.getTotalPages()}" var="i">
                                    <li class="page-item"><a class="page-link ${i == pageNo ? 'active ' : ''}"
                                                             href="/chi-tiet-san-pham/view-mau-sac/${idsp}?searchMS=${param.searchMS}&page=${i}">${i}</a>
                                    </li>
                                </c:forEach>
                                <li class="page-item ${pageNo>=listMau.getTotalPages()?"disabled":""}"><a
                                        class="page-link"
                                        href="/chi-tiet-san-pham/view-mau-sac/${idsp}?searchMS=${param.searchMS}&page=${pageNo+1}">Next</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
