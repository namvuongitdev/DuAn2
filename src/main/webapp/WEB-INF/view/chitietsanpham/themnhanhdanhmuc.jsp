    ...
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            ...
            <div class="container">
                    ...
                    <form>
                        ...
                        <div class="input-group" style="margin-left: 20px">
                            <div class="form-outline">
                                <input type="search" name="searchDM" value="${param.searchDM}"
                ...
                <form:form method="post" action="/chi-tiet-san-pham/add-danh-muc/${idsp}" modelAttribute="danhMuc">
                ...
                <table class="table">
                    ...
                    <tbody>
                    <c:forEach items="${list.getContent()}" var="danh" varStatus="i">
                        <tr onclick="window.location.href='/chi-tiet-san-pham/iddanhmuc/${idsp}?iddanhmuc=${danh.id}';">
                            <th scope="row">${i.index+page}</th>
                            <td>${danh.ten}</td>
                            <td>${danh.trangThai==1?"Kích hoạt":"Ngừng kích hoạt"}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-center">
                            <li class="page-item ${pageNo<=1?"disabled":""}"><a class="page-link"
                                                                                href="/chi-tiet-san-pham/view-danh-muc/${idsp}?searchDM=${param.searchDM}&page=${pageNo-1}">Previous</a>
                            </li>
                            <c:forEach begin="1" end="${list.getTotalPages()}" var="i">
                                <li class="page-item"><a class="page-link ${i == pageNo ? 'active ' : ''}"
                                                         href="/chi-tiet-san-pham/view-danh-muc/${idsp}?searchDM=${param.searchDM}&page=${i}">${i}</a>
                                </li>
                            </c:forEach>
                            <li class="page-item ${pageNo>=list.getTotalPages()?"disabled":""}"><a
                                    class="page-link"
                                    href="/chi-tiet-san-pham/view-danh-muc/${idsp}?searchDM=${param.searchDM}&page=${pageNo+1}">Next</a>
                            </li>
                        </ul>
                    </nav>
                </div>
